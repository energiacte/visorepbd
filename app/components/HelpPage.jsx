...
const LinkId = props => <a onClick={ _ => scrollToId(props.to)  }>{ props.children }</a>;

const ScrollToIndex = _ => <LinkId to='Indice'>
  <small>(Volver al índice <span className="fa fa-chevron-up"></span>)</small>
</LinkId>;
  ...
  <div>
    ...
    <div className="container">
      ...
      <div className="row">
        ...
        <img className="img-fluid offset-md-2" width="60%" src={interfaz_general} />
        ...
        <img className="img-fluid offset-md-2" width="60%" src={interfaz_parametrosgenerales} />
        ...
        <p>El botón &quot;<b><span className="fa fa-download" />&quot; Guardar datos</b> permite descargar en un archivo los datos de los componentes energéticos que se muestran en la aplicación, para poder recuperarlos en otro momento usando el botón &quot;<b><span className="fa fa-upload" /> Cargar datos</b>&quot;.</p>

        <h4>Diagrama de indicadores</h4>

        <img className="img-fluid offset-md-2" width="60%" src={interfaz_indicadores} />
        ...
        <img className="img-fluid offset-md-2" width="60%" src={interfaz_lineasvalores} />
        ...
        <p>La tabla de componentes energéticos dispone además de tres botones de acciones: 
         <b><span className="fa fa-plus" /> Añadir</b>, <b><span className="fa fa-minus" /> Borrar</b> y <b><span className="fa fa-edit" /> Editar</b>,
        ...
        <h4>Editor del componente energético seleccionado (botón <b><span className="fa fa-edit" /> Editar</b>)</h4>

        <p><img className="img-fluid offset-md-2" width="60%" src={interfaz_editor} /></p>
        <p className="card card-body alert-danger">NOTA: El interés de este apartado es exploratorio, al permitir modificar los datos de entrada.</p>
        ...
        <p><img className="img-fluid offset-md-2" width="60%" src={interfaz_entradavalorexpresion} /></p>
        ...
        <p><img className="img-fluid offset-md-2" width="60%" src={interfaz_comentario} /></p>

        <a id="Interfaz4" /><h3>Sección <i>Factores de paso</i> <ScrollToIndex/></h3>

        <img className="img-fluid offset-md-2" width="60%" src={interfaz_factorespaso} />
        ...
        <img className="img-fluid offset-md-2" width="60%" src={interfaz_creditos} />
      ...
      <div className="row">
        ...
        <ol>
          ...
          <li><b>Elaboración de los resultados</b> (pasos <i>j</i> a <i>l</i>): para la comunicación de resultados, incluyendo indicadores globales o parciales.</li>
        </ol>

        <a id="Evaluacion2" /><h3>Proceso de cálculo del <i>VisorEPBD</i> <ScrollToIndex/></h3>
        ...
        <img className="img-fluid offset-md-2 col-lg-8" src={esquema_1balance} />
        ...
        <img className="img-fluid offset-md-2 col-lg-8" src={esquema_2ponderacion} />
        ...
        <img className="img-fluid offset-md-2 col-lg-8" src={esquema_3resultados} />
      </div>
      ...
      <div className="row">
        ...
        <a id="Uso2" /><h3>Introducción de sistemas en <i>VisorEPBD</i> <ScrollToIndex/></h3>
        ...
        <img className="img-fluid col-lg-12" src={linea1vector} alt="Línea de valores correspondiente a un sistema de producción de ACS usando una caldera alimentada por gas natural." />
        ...
        <img className="img-fluid col-lg-12" src={linea2vectores} alt="Líneas de valores correspondientes a una bomba de calor eléctrica para calefacción y refrigeración." />
        ...
        <img className="img-fluid col-lg-12" src={linea3cogen} alt="Líneas de valores correspondientes a un equipo de cogeneración alimentado por gas natural." />
        ...
        <img className="img-fluid col-lg-12" src={linea4paneltermico} alt="Línea de valores correspondiente a la introducción de paneles solares térmicos para el servicio de ACS." />
        ...
        <img className="img-fluid col-lg-12" src={linea4panelfotovoltaico} alt="Línea de valores correspondiente a la producción de electricidad con paneles solares fotovoltaicos." />
        ...
        <a id="Uso3" /><h3>Estimación de la de la energía final a partir de la demanda <ScrollToIndex/></h3>
        ...
        <img className="img-fluid col-lg-12" src={ejemplo1gasdemanda} alt="Demanda asociada al servicio de calefacción." />
        ...
        <img className="img-fluid col-lg-12" src={ejemplo1gasconsumo} alt="Consumo obtenido a partir de la demanda de calefacción." />
        ...
        <img className="img-fluid col-lg-12" src={ejemplo2bdcdemanda} alt="Demandas asociadas al servicio de calefacción y refrigeración." />
        ...
        <img className="img-fluid col-lg-12" src={ejemplo2bdcconsumo} alt="Consumos obtenidos a partir de las demandas de calefacción y refrigeración." />
        ...
        <img className="img-fluid col-lg-12" src={ejemplo3cogendemanda} alt="Demanda asociada al servicio de calefacción." />
        ...
        <img className="img-fluid col-lg-12" src={ejemplo3cogenconsumo} alt="Consumo y producción obtenidos a partir de la demanda de calefacción." />
