      ...
      <div>
        ...
        <div className="container">
          ...
          <div className="row">
            ...
            <p>De ese modo, una bomba de calor que aporte calor al edificio (por ejemplo, para el servicio de calefacción o de ACS) se reflejaría en el <i>VisorEPBD</i> mediante dos líneas de valores de consumo, una del vector energético <tt>MEDIOAMBIENTE</tt> y otra del combustible o electricidad que use el sistema. En el caso de que el equipo operase en el modo de enfriamiento no se realiza aportación del vector <tt>MEDIOAMBIENTE</tt>tt>, sino que se vierte calor del edificio al medioambiente, y únicamente figuraría en <i>VisorEPBD</i> el consumo de otro vector energético.</p>
